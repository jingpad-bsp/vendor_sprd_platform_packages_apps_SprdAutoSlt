...
public class ComboPreferences implements SharedPreferences,
    ...
    private static WeakHashMap<Context, ComboPreferences> sMap = new WeakHashMap<Context, ComboPreferences>();
    ...
    public void setLocalId(Context context, int cameraId) {
        ...
        mPrefLocal = context.getSharedPreferences(prefName,
