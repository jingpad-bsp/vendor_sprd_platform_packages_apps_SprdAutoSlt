...
public class TpPatternDiagActivity extends Activity {
    ...
    public static TpPatternDiagActivity instance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tp_pattern_diag);
